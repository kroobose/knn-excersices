...
%
%   [YEAR, MONTH, DAY, HOUR, MINUTE, SECOND] = JD2DATE(JD) returns
%   the
%   Gregorian calendar date (year, month, day, hour, minute, and
%   second)
%   corresponding to the Julian day number JD.
%
%   Start of the JD (Julian day) count is from 0 at 12 noon 1 JAN
%   -4712
%   (4713 BC), Julian proleptic calendar.  Note that this day count
%   conforms
%   with the astronomical convention starting the day at noon, in
%   contrast
%   with the civil practice where the day starts with midnight.
%
%   Astronomers have used the Julian period to assign a unique
%   number to
%   every day since 1 January 4713 BC.  This is the so-called
%   Julian Day
%   (JD). JD 0 designates the 24 hours from noon UTC on 1 January
%   4713 BC
...
%   URL:         http://home.online.no/~pjacklam
   ...
   % Adding 0.5 to JD and taking FLOOR ensures that the date is
   % correct.
