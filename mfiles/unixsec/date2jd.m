...
%
%   JD = DATE2JD(YEAR, MONTH, DAY, HOUR, MINUTE, SECOND) returns
%   the Julian
%   day number of the given date (Gregorian calendar) plus a
%   fractional part
...
%
%   Start of the JD (Julian day) count is from 0 at 12 noon 1
%   January -4712
...
% The following algorithm is a modified version of the one found
% in the
% Calendar FAQ.
